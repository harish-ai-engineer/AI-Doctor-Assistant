...
export function Evaluations() {
  return (
    <div>
      ...
      <Card className="mt-5 overflow-hidden"><div className="border-b p-5"><h2 className="font-bold">Recent feedback</h2><p className="text-xs text-muted-foreground">Human scores sent to AgentGuard</p></div>{[
